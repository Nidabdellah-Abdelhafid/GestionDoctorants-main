...
publicationCourante :any;
  ...
  constructor(protected activatedRoute: ActivatedRoute,private router: Router,public _sanitizer: DomSanitizer,protected doctorantService: DoctorantService, protected dataUtils: DataUtils,protected publicationservice: PublicationService,protected doctorantservice :DoctorantService , protected membreEquipeservice: MembreEquipeService) {}
  ...
  afficherChamps1(pub: any):void {
    this.router.navigate(['/doctorant',pub, 'view']);
    window.close();
