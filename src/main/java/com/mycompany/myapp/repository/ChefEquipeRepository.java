...
public interface ChefEquipeRepository extends JpaRepository<ChefEquipe, Long> {
    ...
    @Query(value="SELECT * FROM chef_equipe WHERE extra_user_id in (SELECT id FROM extra_user  WHERE internal_user_id =:id ) and date_fin ='2000-04-28' ", nativeQuery = true)
